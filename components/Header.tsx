      ...
      <div className="mx-auto flex max-w-2xl items-center justify-between gap-3 px-4 py-2.5">
        <Link href="/" className="flex min-w-0 items-center gap-2.5">
          ...
          <div className="min-w-0 text-left">
            ...
            <div className="text-[10px] text-forest-500">Non-partisan · Demands, not rankings</div>
          </div>
        </Link>
        <Link
          href="/about"
          className="shrink-0 text-[11px] font-semibold text-forest-700 underline-offset-2 hover:underline"
        >
          Charter
        </Link>
      </div>
