      ...
      <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="font-display text-sm font-bold tracking-wide text-forest-700">ISEYC</div>
            <div className="text-[10px] uppercase tracking-widest text-gold-600">Civic Mandate 2027</div>
          </div>
        </Link>
