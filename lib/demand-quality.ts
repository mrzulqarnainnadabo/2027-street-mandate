/**
 * Soft quality signals for citizen demands.
 * Never blocks submit by itself — form/API still own validation.
 * Goal: nudge away from campaign slogans toward service outcomes.
 */
